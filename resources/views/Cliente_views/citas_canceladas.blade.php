...
@include("alerts.eliminar_cita_confirmada")
    <link rel="stylesheet" href="{{asset('css/styleCitasCanceladas.css')}}">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css">

    <div class="cont3">
        <div class="cabecera-container">
            <div class="search-container"></div>
            <div class="put-title">CITAS CANCELADAS</div>
            <div class="search-container"></div>
        </div>
...
<div class="final-section">ESTADO DE LA CITA</div>
</div>
...
@if ($cita->estado_cita==3)
  Cita Cancelada Por Mi
@elseif ($cita->estado_cita==4)
Cita Cancelada Por la veterinaria
  @endif  
</div>
