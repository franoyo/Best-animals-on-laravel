...
<link rel="stylesheet" href="{{asset('css/styleCrudProductos.css?v=1.19')}}">
...
<nav class="botones-container">
                    <a class="boton-reporte" href="{{route('productosExcel')}}">EXCEL</a>
                    <a class="boton-reporte" href="{{route('reporteProductos')}}">PDF</a>
