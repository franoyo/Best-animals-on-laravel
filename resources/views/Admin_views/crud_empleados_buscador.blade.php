...
<link rel="stylesheet" href="{{asset('css/style21.css?V=1.14')}}">


                <div class="insert-title">
                <div class="container-buscador">
<form class="put-search" method="get" action="{{route('filtroCrudEmpleados')}}">
...
<h2>GESTION EMPLEADOS</h2>
                   ...
                   <nav class="botones-container">
                    <a class="boton-reporte" href="{{route('empleadosExcel')}}">EXCEL</a>
                    <a class="boton-reporte" href="{{route('reporteEmpleados')}}">PDF</a>
